  ...
  $('body').on('click', function(){
    ...
    if ($('#' + id).length){
      ...
      var html = [
        ...
        '<a href="https://www.facebook.com/sharer.php?u=' + encodedUrl + '" class="article-share-facebook" target="_blank" title="Facebook"><i class="fa fa-facebook-official"></i></a>',
